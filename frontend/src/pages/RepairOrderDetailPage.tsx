...
function InfoTab({ order, onChanged }: { order: RepairOrderDetail; onChanged: () => void }) {
  ...
  // Fotos subidas antes de esta separación no tienen "category" —
  // se tratan como estado de ingreso, ya que originalmente la galería
  // general era exactamente eso ("evidencia del estado al recibirlo").
